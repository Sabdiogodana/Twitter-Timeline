package com.sabdio.twittertimeline

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.recyclerview.widget.LinearLayoutManager
import com.sabdio.twittertimeline.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun displayTweets(){
        var tweet = Tweets("SabdioG @sabby122 Jul 9,2022","Software Developer","","","34","","10","50","218","","20")
